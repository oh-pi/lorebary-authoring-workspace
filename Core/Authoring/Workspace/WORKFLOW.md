...
6. Separate the downloadable JSON from field-only paste text and full text exports. The prompt export header is not part of `modules[*].content`. Serialize structured character personality objects into a string once for the card-v2 structured variant; detailed exports use an object.
